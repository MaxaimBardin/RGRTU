...
namespace upr3
{
    public partial class Form1 : Form
    {
        ...
        int[] w_arr = new int[7];  // Текущее множество парето-оптимальных векторов
        double[] wal_arr = new double[8];   //Массив весов double[] val_arr = new double [7];
        int max_krit = 0;
        int count_krit = 0;
        ...
        private void Button_Prog_Click(object sender, EventArgs e)
        {
            ...
            int wk = Convert.ToInt32(textBox_krit.Text);// важный критерий wk--;
            wk--;
            double q = Convert.ToDouble(textBox_otv.Text);//wj
            if(textBox_krit.Text == "1")
{
                max_krit = 1;
            }
        ...
        private void dataGridViewPareto1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
